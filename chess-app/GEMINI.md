...
# External Guidelines (Merged from Gist)
The following content is imported from an external source (Gist: 3f9188eb0a5114fffa5d8cb4f14fe5a4) and serves as additional guidelines for AI assistant workflows, context management, and safety protocols.
